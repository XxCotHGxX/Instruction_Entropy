...
def find_optimal_kink(df, target='ln_wage_eq'):
    best_r2 = -1
    best_kink = 0
    # Search between 20th and 80th percentile
...
def run():
    if not os.path.exists('data/subtask_dataset.csv'):
    ...
    plt.title('Regression Kink Design: The Non-Linear Labor Floor (N=58)', fontsize=14)
    ...
    print("Expanded Kink Plot generated.")
